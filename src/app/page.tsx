    ...
    <div className="h-full w-full flex flex-col">
      ...
      <div className="flex flex-col h-screen">
        <div className="w-full h-full flex flex-col justify-start pl-48 mt-48">
          <h1 className="text-text text-7xl mb-24"><span className="text-accent">Meet</span> the team!</h1>
          <div className="w-full flex justify-center items-center">
            <div className="grid-container gap-y-24 w-5/6">
              <MeetCard blurb={"Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Pharetra vel turpis  nunc eget lorem..."} imgPath={null}/>
              <MeetCard blurb={"Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Pharetra vel turpis  nunc eget lorem..."} imgPath={null}/>
              <MeetCard blurb={"Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Pharetra vel turpis  nunc eget lorem..."} imgPath={null}/>
              <MeetCard blurb={"Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Pharetra vel turpis  nunc eget lorem..."} imgPath={null}/>
              <MeetCard blurb={"Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Pharetra vel turpis  nunc eget lorem..."} imgPath={null}/>
